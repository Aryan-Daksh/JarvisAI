...
__all__ = [
    'ISpeechMMSysAudio', 'SpShortcut', 'SRCS_Enabled',
    'SpeechEngineConfidence', 'DISPID_SASetState', 'SVP_8',
    'DISPID_SAStatus', 'ISpeechVoice', 'SPPS_RESERVED3',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SRCRetainedAudio',
    ...
    'SpeechRuleState', 'DISPID_SPAsCount', 'STSF_AppData',
    'DISPID_SMSSetData', 'SVP_19', 'SP_VISEME_11',
    'DISPID_SRSAudioStatus', 'eLEXTYPE_PRIVATE18', 'SpVoice',
    'DISPID_SVEVoiceChange', 'DISPID_SPAs_NewEnum', 'SASPause',
    'eLEXTYPE_PRIVATE7', 'DISPID_SPIProperties',
    'SAFTADPCM_11kHzMono', 'SSFMCreateForWrite',
    'DISPID_SOTMatchesAttributes', 'SpeechEmulationCompareFlags',
    'SPWT_LEXICAL', 'SRTSMLTimeout', 'SpSharedRecognizer',
    'SPRECOSTATE', 'SGRSTTTextBuffer',
    'DISPID_SGRSAddSpecialTransition', 'SVP_15', 'SFTSREngine',
    'DISPID_SVSRunningState', 'ISpeechRecoResultTimes',
    'SVF_Emphasis', 'DISPID_SRGDictationUnload', 'SPPS_Interjection',
    'DISPID_SRRSaveToMemory', 'SpTextSelectionInformation',
    'DISPID_SRCEAdaptation', 'SPDKL_CurrentUser',
    'DISPID_SABufferNotifySize', 'DISPID_SRGCmdSetRuleIdState',
    'SpeechEngineProperties', 'DISPID_SRIsShared',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpeechCategoryAudioOut', 'SPBINARYGRAMMAR',
    ...
    'SP_VISEME_13', 'SLODynamic', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SRRAudio', 'SPDKL_DefaultLocation', 'DISPID_SLWsCount',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SDA_No_Trailing_Space',
    'ISpPhoneticAlphabetSelection', 'DISPID_SPEActualConfidence',
    'SpeechVoiceCategoryTTSRate', 'ISpLexicon',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SGRSTPropertyValue',
    'SPWORDTYPE', 'SDA_Consume_Leading_Spaces',
    'SpeechDataKeyLocation', 'SGLexical',
    ...
    'SVSFPurgeBeforeSpeak', 'SPPS_RESERVED2', 'DISPID_SpeechLexicon',
    'SAFTGSM610_11kHzMono', 'ISpeechLexiconPronunciation',
    'SVEAudioLevel', 'SP_VISEME_6', 'DISPID_SRCEFalseRecognition',
    'SpeechTokenValueCLSID', 'DISPID_SRCERecognitionForOtherContext',
    'SPPROPERTYINFO', 'SASRun', 'ISpeechObjectTokens',
    'SAFT44kHz16BitStereo', 'DISPID_SLWWord', 'SpeechPartOfSpeech',
    'DISPID_SWFEAvgBytesPerSec', 'SREPropertyStringChange',
    'DISPID_SDKSetLongValue', 'SVP_10', 'SWTDeleted',
    'DISPID_SVPause', 'DISPID_SPRDisplayAttributes',
    'SAFT48kHz16BitMono', 'DISPID_SVSyncronousSpeakTimeout',
    'SPEI_START_SR_STREAM', 'DISPID_SRRTStreamTime', 'DISPID_SAFGuid',
    'DISPID_SpeechVoice', 'SDTLexicalForm', 'eLEXTYPE_PRIVATE20',
    'ISpProperties', 'DISPID_SGRSTs_NewEnum',
    'IInternetSecurityManager', 'SPSMF_SAPI_PROPERTIES',
    'SVSFUnusedFlags', 'DISPID_SpeechPhraseRule',
    'SECNormalConfidence', 'SVP_9', 'SPEVENT',
    'DISPID_SpeechPhraseElement', 'SP_VISEME_12', 'SPEI_UNDEFINED',
    'DISPID_SPARecoResult', 'SpeechPropertyComplexResponseSpeed',
    'eLEXTYPE_PRIVATE5', 'DISPID_SLGenerationId', 'ISpRecoResult',
    'DISPID_SPRulesItem', 'DISPID_SRGState', 'SVP_16',
    'DISPID_SLRemovePronunciation', 'eLEXTYPE_PRIVATE9',
    'DISPID_SLWType', 'SpeechMicTraining',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SGRSAddWordTransition',
    'Speech_Max_Word_Length', 'SINoSignal', 'SP_VISEME_1',
    'SP_VISEME_3', 'SP_VISEME_20', 'SpeechSpecialTransitionType',
    'ISpVoice', 'SVSFDefault', 'DISPID_SOTCGetDataKey',
    'ISpPhoneConverter', 'SRAInterpreter', 'SpeechLexiconType',
    'SRTStandard', 'SVEStartInputStream', 'ISpeechLexiconWord',
    'DISPID_SPRs_NewEnum', 'SPRST_ACTIVE', 'SPCS_ENABLED',
    'DISPID_SpeechObjectTokenCategory', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SOTCDefault', 'DISPID_SGRSTPropertyId',
    'DISPID_SVSLastResult', 'DISPID_SGRSTNextState',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPPHRASEPROPERTY', 'DISPID_SVSkip',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SASState', 'SVP_1',
    'eLEXTYPE_PRIVATE1', 'SpeechWordType', 'DISPID_SpeechRecoContext',
    'SpeechPropertyAdaptationOn', 'DISPID_SPELexicalForm',
    'DISPID_SPRuleEngineConfidence', 'SPAS_RUN', 'SpObjectToken',
    'DISPID_SRRGetXMLResult', 'SGDisplay', 'ISpeechBaseStream',
    'DISPID_SRRTimes', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SVSPhonemeId', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SRState', 'DISPID_SPEAudioSizeTime', 'SRTAutopause',
    'DISPID_SCSBaseStream', 'SPADAPTATIONRELEVANCE', 'SRAImport',
    'DISPID_SGRClear', 'SRERequestUI', 'ISpeechRecoContext',
    'SPXRO_Alternates_SML', 'DISPID_SpeechLexiconWords',
    'SDTAlternates', 'SpeechLoadOption', 'SLTUser',
    'SAFT44kHz16BitMono', 'DISPID_SLWLangId', 'SpeechRuleAttributes',
    'DISPID_SPCIdToPhone', 'SPSNotOverriden', 'SRSEDone',
    'SGSDisabled', 'DISPID_SPRuleFirstElement', 'SPCT_DICTATION',
    'ISpRecoContext2', 'SPEI_SOUND_END', 'DISPID_SVAlertBoundary',
    'tagSTATSTG', 'SpeechVisemeType', '__MIDL_IWinTypes_0009',
    'ISpeechPhraseRules', 'DISPID_SVEViseme',
    'DISPID_SVAudioOutputStream', 'DISPID_SLWPronunciations',
    'DISPID_SGRSTType', 'DISPID_SPCPhoneToId', 'SSFMCreate',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SRCESoundEnd',
    'SPRST_NUM_STATES', 'SpStream', 'DISPID_SABufferInfo',
    'DISPID_SDKGetBinaryValue', 'SPSERIALIZEDPHRASE', 'ISpDataKey',
    ...
    'ISpeechAudioFormat', 'SPAR_Low', 'SPEI_TTS_BOOKMARK',
    'DISPID_SpeechRecognizer', 'IEnumString',
    'SPEI_FALSE_RECOGNITION', 'SPGS_EXCLUSIVE', 'DISPID_SOTId',
    'ISpeechFileStream', 'ISpShortcut', 'SpeechWordPronounceable',
    'DISPID_SPPs_NewEnum', 'SpeechCategoryVoices', 'SPINTERFERENCE',
    'SVP_12', 'DISPID_SLWsItem', 'SECFIgnoreKanaType', 'SPSUnknown',
    'DISPID_SOTsItem', 'SDKLCurrentConfig',
    'DISPID_SPERequiredConfidence', 'SAFT24kHz16BitStereo',
    'SVSFPersistXML', 'SPEI_MIN_SR', 'DISPID_SBSSeek',
    'ISpeechRecoResult', 'SGDSActiveWithAutoPause',
    'SpeechRecoProfileProperties', 'SVSFIsFilename',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPEI_RECO_STATE_CHANGE',
    'SPPS_RESERVED4', 'DISPID_SDKEnumValues',
    'DISPID_SPRules_NewEnum', 'DISPID_SMSALineId', 'ISpObjectToken',
    'SPEI_PROPERTY_STRING_CHANGE', 'SVEBookmark', 'SREPrivate',
    'SWPKnownWordPronounceable', 'DISPID_SpeechLexiconProns',
    'SPRECORESULTTIMES', 'DISPID_SpeechFileStream', 'SVP_4',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SRRAlternates',
    'ISpPhrase', 'SVEWordBoundary', 'DISPID_SRCreateRecoContext',
    'SpeechCategoryRecognizers', 'DISPID_SpeechLexiconPronunciation',
    'SRERecoOtherContext', 'SPAO_NONE',
    'DISPID_SPERetainedStreamOffset', 'SpeechCategoryRecoProfiles',
    'ISpEventSink', 'WAVEFORMATEX', 'DISPID_SRSCurrentStreamPosition',
    'SpeechDiscardType', 'SpeechGrammarTagDictation',
    'DISPID_SLAddPronunciationByPhoneIds', 'SVP_0',
    'DISPID_SMSGetData', 'SPDKL_LocalMachine', 'DISPID_SGRsItem',
    'SPGS_DISABLED', 'DISPID_SGRSTsItem', 'SPSHORTCUTPAIRLIST',
    'eLEXTYPE_MORPHOLOGY', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SOTSetId', 'SPRS_INACTIVE', 'eLEXTYPE_RESERVED8',
    'DISPID_SPPValue', 'eLEXTYPE_PRIVATE12', 'SVP_14',
    'eWORDTYPE_DELETED', 'SWPUnknownWordUnpronounceable',
    'DISPID_SpeechMMSysAudio', 'ISpeechPhraseAlternate',
    'SECLowConfidence', 'SPLO_DYNAMIC', 'DISPID_SRCERequestUI',
    'SRARoot', 'DISPID_SRSCurrentStreamNumber',
    ...
    'SpeechInterference', 'DISPID_SABIMinNotification',
    'ISpeechLexiconWords', 'SPWF_SRENGINE', 'SPSTREAMFORMATTYPE',
    'DISPID_SRRTOffsetFromStart', 'ISpeechCustomStream',
    'DISPID_SLGetPronunciations', 'DISPID_SpeechPhoneConverter',
    'SpeechRecognitionType', 'SPSEMANTICERRORINFO',
    '_RemotableHandle', 'DISPID_SRGDictationSetState', 'DISPID_SPPId',
    'SPCS_DISABLED', 'SVP_2', 'DISPID_SpeechVoiceStatus',
    'DISPID_SGRsCommitAndSave', 'DISPID_SPIAudioStreamPosition',
    'SP_VISEME_7', 'SAFT12kHz16BitStereo',
    'DISPID_SPEAudioStreamOffset', 'SpPhoneticAlphabetConverter',
    'SP_VISEME_10', 'DISPID_SWFEBlockAlign', 'SPCT_SUB_DICTATION',
    'DISPID_SRGetRecognizers', 'DISPID_SVGetAudioInputs',
    'SVSFIsNotXML', 'SPDKL_CurrentConfig', 'SP_VISEME_16',
    'DISPIDSPRG', 'SPEI_SR_BOOKMARK', 'SpUnCompressedLexicon',
    'SPEI_RESERVED1', 'DISPID_SGRsCount', 'SpeechVoiceEvents',
    'SPSHT_EMAIL', 'SpeechTokenKeyAttributes',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SPRNumberOfElements',
    'SPAUDIOSTATE', 'eLEXTYPE_PRIVATE14', 'SRSActiveAlways',
    'ISequentialStream', 'eLEXTYPE_PRIVATE8', 'SSTTDictation',
    'DISPID_SFSOpen', 'DISPID_SRProfile', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SPIGrammarId', 'SVEViseme', 'SPVISEMES',
    'DISPID_SGRsFindRule', 'DISPID_SPRuleId',
    'DISPID_SpeechWaveFormatEx', 'SPAR_Medium', 'SPXRO_SML',
    'eLEXTYPE_RESERVED7', 'DISPID_SVVoice', 'SDKLLocalMachine',
    'SpMMAudioOut', 'SAFTGSM610_8kHzMono', 'SPVPRI_OVER',
    'SPEI_MAX_SR', 'DISPID_SOTs_NewEnum', 'SVF_Stressed',
    ...
    'SAFTExtendedAudioFormat', 'ISpEventSource', 'SGSExclusive',
    'SpeechGrammarState', 'SAFT48kHz8BitStereo', 'SpResourceManager',
    'ISpeechLexiconPronunciations', 'SGRSTTDictation',
    'Speech_Max_Pron_Length', 'DISPID_SPANumberOfElementsInResult',
    'SpeechRegistryUserRoot', 'ISpRecoCategory',
    'DISPID_SRSetPropertyNumber', 'DISPID_SLPSymbolic',
    'DISPID_SpeechRecoResultTimes', 'SpNotifyTranslator',
    'ISpeechGrammarRule', 'DISPID_SWFEExtraData', 'SPSNoun',
    'eLEXTYPE_RESERVED9', 'DISPID_SRCEHypothesis',
    'ISpeechRecognizerStatus', 'SPEI_SOUND_START',
    'DISPID_SGRInitialState', 'SPEI_SENTENCE_BOUNDARY',
    'SP_VISEME_19', 'SVP_20', 'SAFTCCITT_ALaw_44kHzStereo',
    'SpMMAudioIn', 'DISPID_SRCVoice',
    ...
    'SpInProcRecoContext', 'STCRemoteServer', 'SVEEndInputStream',
    'SPEI_RESERVED6', 'SpeechAudioFormatGUIDWave', 'SPEI_RECOGNITION',
    'DISPID_SAFType', 'SPDATAKEYLOCATION', 'SECFIgnoreCase',
    'SpeechTokenKeyUI', 'DISPID_SDKGetlongValue', 'SPLO_STATIC',
    'STCInprocServer', 'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SPEsItem',
    'DISPID_SVGetVoices', 'SpeechAudioFormatGUIDText',
    'ISpeechPhraseElements', 'DISPID_SpeechXMLRecoResult',
    'SpeechAudioState', 'DISPID_SpeechAudioFormat', 'SRTReSent',
    'DISPID_SGRSTText', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SGRSTTRule', 'ISpeechVoiceStatus', 'DISPID_SDKOpenKey',
    'eLEXTYPE_PRIVATE13', 'SPSMF_SRGS_SAPIPROPERTIES', 'SVP_17',
    'SVF_None', 'DISPID_SpeechVoiceEvent', 'SAFT24kHz16BitMono',
    'SpMMAudioEnum', 'SAFT24kHz8BitMono', 'SRESoundStart',
    'DISPID_SPPName', 'DISPID_SRRRecoContext', 'SAFT8kHz8BitStereo',
    'SpWaveFormatEx', 'SVESentenceBoundary', 'SPSHORTCUTPAIR',
    'SSSPTRelativeToCurrentPosition', 'STCAll', 'SPAUDIOBUFFERINFO',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SVEBookmark',
    'SAFTCCITT_ALaw_44kHzMono', 'SREInterference',
    ...
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SAFT22kHz8BitMono',
    'SpeechRecognizerState', 'DISPID_SLGetGenerationChange',
    'SpeechRunState', 'ISpeechMemoryStream', 'DISPID_SRRAudioFormat',
    'DISPID_SLPPartOfSpeech', 'DISPID_SGRSRule', 'SPXMLRESULTOPTIONS',
    'eLEXTYPE_RESERVED6', 'SPEI_RESERVED3',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPFM_OPEN_READONLY',
    'ISpeechWaveFormatEx', 'DISPID_SRGSetWordSequenceData',
    'SpSharedRecoContext', 'SAFT22kHz16BitMono', 'DISPID_SGRAddState',
    'eLEXTYPE_PRIVATE17', 'DISPID_SPRuleNumberOfElements',
    'SpeechVoiceSpeakFlags', 'ISpeechLexicon',
    'ISpeechPhraseProperties', 'DISPID_SpeechGrammarRule',
    'SGRSTTEpsilon', 'DISPID_SLPs_NewEnum', 'DISPID_SRGId',
    'ISpStreamFormat', 'DISPID_SRCBookmark', 'DISPID_SPEs_NewEnum',
    'DISPID_SOTsCount', 'SpeechFormatType',
    'SAFTCCITT_ALaw_11kHzStereo', 'eLEXTYPE_PRIVATE2',
    'DISPID_SpeechPhraseInfo', 'ISpeechPhraseReplacements',
    'DISPID_SWFEFormatTag', 'tagSPPROPERTYINFO', 'SITooSlow',
    'SpNullPhoneConverter', 'DISPID_SOTRemove', '_SPAUDIOSTATE',
    'DISPID_SPIRule', 'SPEI_MIN_TTS',
    'DISPID_SRCERecognizerStateChange', 'SRSActive', 'SWTAdded',
    'ISpNotifyTranslator', 'DISPIDSPTSI_ActiveOffset',
    'ISpMMSysAudio', 'eLEXTYPE_RESERVED10', 'SGDSActive', 'SINone',
    ...
    'DISPID_SRRPhraseInfo', 'SDKLDefaultLocation', 'SPWF_INPUT',
    'SpeechTokenIdUserLexicon', 'DISPID_SPEDisplayText', 'SPWORD',
    'SPSVerb', 'DISPID_SLPsCount', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SOTCEnumerateTokens', 'SDTAll', 'SPTEXTSELECTIONINFO',
    'DISPID_SMSADeviceId', 'DISPID_SOTCategory', 'ISpXMLRecoResult',
    'SAFTADPCM_8kHzStereo', 'SPFM_OPEN_READWRITE',
    'DISPID_SDKEnumKeys', 'SRADefaultToActive',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPLEXICONTYPE',
    'SAFTCCITT_uLaw_8kHzStereo', 'Speech_StreamPos_Asap',
    'SAFTCCITT_ALaw_11kHzMono', 'SPSFunction', 'SDTProperty',
    'SINoise', 'SVP_11', 'SAFT8kHz16BitStereo',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SRSClsidEngine',
    'DISPID_SRGIsPronounceable', 'DISPID_SVVolume', 'DISPID_SVStatus',
    'SSSPTRelativeToEnd', 'DISPID_SpeechLexiconWord',
    'DISPID_SRCRetainedAudioFormat', 'SAFTDefault',
    'SpPhraseInfoBuilder', 'SpAudioFormat', 'DISPID_SPRuleParent',
    'SVP_5', 'DISPID_SPRuleConfidence', 'DISPID_SVGetProfiles',
    'eLEXTYPE_PRIVATE19', 'DISPID_SRCResume', 'SRERecognition',
    'ISpeechAudio', 'DISPID_SGRs_NewEnum', 'eWORDTYPE_ADDED',
    'eLEXTYPE_PRIVATE3', 'DISPID_SPPsCount', 'SDTRule',
    ...
    'SPAUDIOSTATUS', 'SPCT_SUB_COMMAND', 'SVPNormal',
    'SPAUDIOOPTIONS', 'DISPID_SGRSTransitions',
    'ISpeechGrammarRuleState', 'DISPIDSPTSI',
    'DISPID_SpeechBaseStream', 'DISPID_SLAddPronunciation',
    'SRAExport', 'SpeechAllElements', 'SREAudioLevel',
    'SAFTNoAssignedFormat', 'DISPID_SRCRecognizer',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SGRsDynamic',
    'ISpObjectWithToken', 'SRTEmulated', 'SP_VISEME_2',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SDKCreateKey',
    'DISPID_SOTCSetId', 'SVSFParseSapi', 'SBOPause',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SPPParent', 'SDTAudio',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPCT_COMMAND',
    'SGDSActiveUserDelimited', 'SPPARTOFSPEECH',
    'DISPID_SpeechCustomStream', 'SPWORDPRONOUNCEABLE',
    'eLEXTYPE_RESERVED4', 'SVEPhoneme', 'eLEXTYPE_PRIVATE11',
    'STSF_LocalAppData', 'DISPID_SVPriority',
    'DISPID_SVSInputWordLength',
    'DISPID_SpeechGrammarRuleStateTransition', 'SVPOver',
    'SAFT48kHz8BitMono', 'SFTInput', 'SP_VISEME_14', 'SRADynamic',
    'SVSFParseMask', 'DISPID_SABIBufferSize', 'DISPID_SWFEChannels',
    'DISPID_SRAudioInputStream', 'ISpNotifySource', 'SVP_13',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SVSpeakCompleteEvent',
    'SPGRAMMARWORDTYPE', 'DISPID_SpeechPhraseProperty',
    'SPGRAMMARSTATE', 'SECFDefault', 'SAFTADPCM_8kHzMono',
    'DISPID_SGRSTsCount', 'SGRSTTWord', 'DISPID_SGRsCommit',
    'DISPID_SVEWord', 'DISPID_SRGetPropertyNumber',
    'SPWORDPRONUNCIATION', 'SSTTWildcard', 'SpeechAddRemoveWord',
    'SRATopLevel', 'DISPID_SPEPronunciation',
    'DISPID_SPPNumberOfElements', 'SPEI_RESERVED5', 'SPVPRI_NORMAL',
    'SLOStatic', 'SPWAVEFORMATTYPE', 'ISpeechAudioBufferInfo',
    'SPFM_NUM_MODES', 'DISPID_SPEAudioTimeOffset', 'DISPID_SBSWrite',
    'DISPID_SpeechObjectTokens', 'DISPID_SRRSpeakAudio',
    'DISPID_SVEStreamStart', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SVSLastBookmark', 'DISPID_SGRSTPropertyName',
    'SAFTADPCM_22kHzMono', 'DISPID_SPPBRestorePhraseFromMemory',
    'ISpeechRecoGrammar', 'SPAO_RETAIN_AUDIO',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SPERetainedSizeBytes',
    'SVP_6', 'DISPID_SRGSetTextSelection', 'DISPID_SGRAddResource',
    'SAFT11kHz16BitStereo', 'SECFIgnoreWidth', 'DISPID_SGRSTWeight',
    'DISPID_SPRsItem', 'SAFTGSM610_44kHzMono', 'SVP_3', 'SLTApp',
    ...
    'SPEI_END_SR_STREAM', 'DISPID_SRSNumberOfActiveRules',
    'SPAR_Unknown', 'SPEI_PHONEME', 'SREHypothesis',
    'SPBOOKMARKOPTIONS', 'DISPID_SRGCmdLoadFromObject', 'SPCT_SLEEP',
    'SGSEnabled', 'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SLPPhoneIds',
    'SRCS_Disabled', 'DISPID_SRCSetAdaptationData',
    'ISpSerializeState', 'DISPID_SVSInputSentencePosition',
    'DISPID_SVDisplayUI', 'ISpPhraseAlt', 'SAFT11kHz8BitMono',
    'DISPID_SBSFormat', 'SPEI_START_INPUT_STREAM',
    'ISpeechPhraseElement', 'ISpeechGrammarRules',
    'SpeechPropertyResourceUsage', 'SVPAlert', 'SAFT12kHz8BitStereo',
    'SP_VISEME_17', 'DISPID_SRGReset',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SAVolume',
    'SpCompressedLexicon', 'SVP_18', 'SpeechPropertyResponseSpeed',
    'DISPID_SPIReplacements', 'SPSEMANTICFORMAT',
    'ISpeechXMLRecoResult', 'SPPS_SuppressWord',
    'DISPID_SRSetPropertyString', 'SVEAllEvents',
    'SAFT24kHz8BitStereo', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SRCESoundStart', 'SPPS_Modifier', 'SPPS_Unknown',
    'SDTDisplayText', 'SITooQuiet', 'DISPID_SLPsItem',
    'STSF_FlagCreate', 'DISPID_SRRTLength', 'SP_VISEME_5',
    'DISPID_SVSpeak', 'SVP_7', 'SPINTERFERENCE_TOOSLOW',
    'SpeechStreamFileMode', 'ISpGrammarBuilder', 'SREStreamStart',
    'eLEXTYPE_PRIVATE16', 'SpeechDisplayAttributes',
    'SAFT8kHz16BitMono', 'SAFT32kHz16BitMono',
    'DISPID_SPRuleChildren', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SRGDictationLoad', 'SPEI_PHRASE_START', 'SPEI_SR_PRIVATE',
    'SSFMOpenForRead', 'SPEI_INTERFERENCE', 'SAFT22kHz16BitStereo',
    'IInternetSecurityMgrSite', 'DISPID_SVWaitUntilDone',
    'DISPID_SRSSupportedLanguages', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SpeechRecoResult', 'SRAORetainAudio',
    'DISPID_SpeechAudioBufferInfo', 'eLEXTYPE_LETTERTOSOUND',
    'SPEI_VISEME', 'SpMemoryStream', 'SPSHT_NotOverriden',
    'SPSHORTCUTTYPE', 'DISPID_SDKDeleteKey', 'SPRS_ACTIVE',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SpeechDataKey',
    'DISPID_SDKSetStringValue', 'SVSFNLPSpeakPunc',
    'DISPID_SVSInputSentenceLength', 'DISPID_SPRuleName', 'UINT_PTR',
    'SPPS_Noncontent', 'DISPID_SASFreeBufferSpace',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SRGRecoContext',
    'SAFT32kHz16BitStereo', 'SPAS_CLOSED', 'SREAdaptation',
    'DISPID_SPIAudioSizeTime',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'ISpObjectTokenCategory',
    'SRSInactiveWithPurge', 'DISPID_SPPChildren',
    'SPRECOGNIZERSTATUS', 'DISPID_SPAPhraseInfo', 'SAFT16kHz8BitMono',
    'SPPHRASEELEMENT', 'SDTPronunciation', 'SAFT11kHz16BitMono',
    'SP_VISEME_8', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SBSRead', 'ISpeechDataKey', 'ISpeechObjectTokenCategory',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SASClosed', 'SPWORDLIST',
    'DISPID_SVEAudioLevel', 'SWPUnknownWordPronounceable',
    'SSSPTRelativeToStart', 'SRSEIsSpeaking', 'DISPID_SPEsCount',
    'DISPID_SPILanguageId', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SpeechPhraseRules', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SPWT_PRONUNCIATION', 'SBONone', 'DISPID_SADefaultFormat',
    'SPEI_REQUEST_UI', 'SRSInactive', 'DISPID_SGRName',
    'SPEI_VOICE_CHANGE', 'ISpStream', 'SPEI_MAX_TTS',
    'SDTReplacement', 'DISPID_SPAsItem', 'SPSHT_OTHER',
    'ISpeechObjectToken', 'DISPID_SRGRules', 'SPPS_Noun',
    'ISpeechRecoResult2', 'DISPID_SRRTTickCount', 'SPBO_TIME_UNITS',
    'DISPID_SRCCreateResultFromMemory', 'SpFileStream',
    'SpeechCategoryAppLexicons', 'IEnumSpObjectTokens',
    'DISPID_SPISaveToMemory', 'SAFTADPCM_11kHzStereo',
    'SPSInterjection', 'SPSHT_Unknown', 'DISPID_SRIsUISupported',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SpeechAudioStatus',
    'SP_VISEME_15', 'SPWORDPRONUNCIATIONLIST', 'SVP_21',
    'ISpStreamFormatConverter',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpeechBookmarkOptions', 'DISPID_SRRGetXMLErrorInfo',
    'SpeechRecoContextState', 'SRAONone', 'SRESoundEnd',
    'ISpRecoContext', 'ISpResourceManager',
    'ISpeechPhraseInfoBuilder', 'DISPID_SPEDisplayAttributes',
    'DISPID_SPIEngineId', 'SAFT32kHz8BitMono',
    'SPEI_END_INPUT_STREAM', 'SPCATEGORYTYPE', 'SPPS_RESERVED1',
    'SVSFVoiceMask', 'DISPID_SRCAudioInInterferenceStatus',
    'SPAR_High', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SGRSAddRuleTransition', 'SPPHRASE',
    'ISpeechRecoResultDispatch', 'DISPID_SWFESamplesPerSec',
    'SECHighConfidence', 'SpLexicon', 'DISPID_SpeechPhraseBuilder',
    'SGRSTTWildcard', 'SPVOICESTATUS', 'eLEXTYPE_APP',
    'eLEXTYPE_VENDORLEXICON', 'ISpRecoGrammar2', 'SPEVENTENUM',
    'SPBO_PAUSE', 'DISPID_SMSAMMHandle', 'SSTTTextBuffer',
    'DISPID_SOTGetStorageFileName', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SGRSTRule', 'DISPID_SOTDisplayUI', 'SREPhraseStart',
    'DISPID_SRCCmdMaxAlternates', 'SAFT44kHz8BitStereo',
    'SAFTGSM610_22kHzMono', 'SPSMF_UPS', 'DISPID_SRRSetTextFeedback',
    'SpeechAudioFormatType', 'SPINTERFERENCE_NOISE', 'SREStateChange',
    'SAFT16kHz16BitStereo', 'DISPID_SPIElements',
    'DISPID_SVIsUISupported', 'ISpeechPhraseRule',
    'SpeechAudioProperties', 'DISPID_SVSLastStreamNumberQueued',
    'SPEI_RESERVED2', 'DISPID_SRCEStartStream', 'SP_VISEME_9',
    'DISPID_SPIGetText', 'SPSModifier', 'SPINTERFERENCE_TOOQUIET',
    'eLEXTYPE_PRIVATE15', 'ISpPhoneticAlphabetConverter', 'ISpAudio',
    'SREAllEvents', 'DISPID_SRRDiscardResultInfo', 'SAFTText',
    'STCLocalServer', 'SAFT22kHz8BitStereo', 'DISPID_SRCEAudioLevel',
    'DISPID_SPRsCount', 'SGDSInactive', 'SP_VISEME_21',
    'DISPID_SRGetFormat', 'SPWT_DISPLAY', 'DISPID_SRStatus',
    'SAFTADPCM_44kHzMono', 'DISPID_SPIRetainedSizeBytes',
    'eLEXTYPE_PRIVATE10', 'SGPronounciation', 'SPEI_TTS_PRIVATE',
    '_ISpeechVoiceEvents', 'SPRECOCONTEXTSTATUS',
    'DISPID_SPRulesCount', 'ISpeechPhraseAlternates',
    'SAFTCCITT_ALaw_22kHzStereo', 'SpeechRetainedAudioOptions',
    'SPPHRASERULE', 'DISPID_SOTCreateInstance', 'SpeechUserTraining',
    'SASStop', 'SVSFNLPMask', 'SPSLMA',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SFSClose',
    'SPRULESTATE', 'SREBookmark', 'SPFM_CREATE_ALWAYS',
    'DISPID_SOTCId', 'SpeechCategoryAudioIn',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'ISpeechRecognizer',
    'SPINTERFERENCE_LATENCY_WARNING', 'SVSFParseSsml',
    ...
    'STSF_CommonAppData', 'SAFTCCITT_uLaw_8kHzMono', 'ISpNotifySink',
    'SRTExtendableParse', 'DISPID_SGRId', 'SAFT8kHz8BitMono',
    'DISPID_SPRText', 'SPBO_AHEAD', 'SAFT48kHz16BitStereo',
    'DISPID_SRGCommit', 'SREPropertyNumChange', 'DISPID_SRCState',
    'DISPID_SpeechPhraseElements', 'IStream', 'SPVPRIORITY',
    'SVSFIsXML', 'SPINTERFERENCE_TOOLOUD', 'SVEPrivate',
    'DISPID_SPCLangId', 'SPFILEMODE', 'SSFMOpenReadWrite',
    'SVEVoiceChange', 'SP_VISEME_4', 'SPVPRI_ALERT',
    'DISPID_SRRecognizer', 'DISPID_SRAudioInput',
    'DISPID_SVAudioOutput', 'DISPID_SLGetWords', 'LONG_PTR',
    'DISPID_SREmulateRecognition', 'DISPID_SPIEnginePrivateData',
    'SPGS_ENABLED', 'SDKLCurrentUser', 'DISPID_SRCCreateGrammar',
    'SGLexicalNoSpecialChars',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SRCRequestedUIType', 'SpeechStreamSeekPositionType',
    'DISPID_SLPType', 'DISPID_SpeechPhraseAlternates', 'SPFM_CREATE',
    'SP_VISEME_18', 'DISPID_SRCPause', 'SpeechVoicePriority',
    'DISPID_SVSInputWordPosition', 'SPEI_ADAPTATION',
    'SPRST_INACTIVE', 'ISpRecognizer3', 'SPPS_Verb',
    'DISPID_SABIEventBias', 'eLEXTYPE_USER',
    'DISPID_SVGetAudioOutputs', 'SAFT11kHz8BitStereo',
    'DISPID_SPPFirstElement', 'Speech_Default_Weight',
    'DISPID_SPIAudioSizeBytes', 'SVSFlagsAsync', 'SP_VISEME_0',
    'SPEVENTSOURCEINFO', 'DISPID_SOTRemoveStorageFileName',
    'SPCONTEXTSTATE', 'SECFNoSpecialChars', 'DISPID_SPRFirstElement',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SASCurrentSeekPosition', 'SITooFast',
    'DISPID_SpeechRecoResult2', 'SPLOADOPTIONS', 'SPSERIALIZEDRESULT',
    'DISPID_SPPConfidence', 'DISPID_SASCurrentDevicePosition',
    'SPAS_STOP', 'SpeechCategoryPhoneConverters',
    'ISpeechPhraseProperty', 'SREFalseRecognition', 'SPPS_Function',
    'SPAS_PAUSE', 'DISPID_SPACommit', 'SREStreamEnd',
    'DISPID_SOTIsUISupported', 'DISPID_SPAStartElementInResult',
    'SpPhoneConverter', 'DISPID_SLPLangId', 'SpeechTokenKeyFiles',
    'DISPIDSPTSI_ActiveLength', 'SpeechDictationTopicSpelling',
    'SPEI_HYPOTHESIS', 'SPRULE', 'SITooLoud',
    'DISPID_SRCEventInterests', 'DISPID_SRGCmdLoadFromMemory',
    'SPINTERFERENCE_NONE', 'DISPID_SVResume', 'DISPID_SPPsItem',
    'DISPID_SpeechObjectToken', 'DISPID_SGRsAdd',
    'SpStreamFormatConverter', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SpeechAudioVolume', 'DISPID_SLWs_NewEnum', 'SPBO_NONE',
    'Speech_StreamPos_RealTime', 'SPPS_LMA', 'SAFT16kHz8BitStereo'
]
